...
#define __HARDWARELIB_H
    ...
    ********************************************************************************************/      
    ...
    #define _ATD_DIO_INDEX_BAK1_CHAN   5     //开关1对应模拟信号，对应接插件X10   0
    #define _ATD_DIO_INDEX_BAK2_CHAN   6     //开关2对应模拟信号，对应接插件X1    1
    #define _ATD_DIO_INDEX_BAK3_CHAN   7     //开关3对应模拟信号，对应接插件X2    2
    #define _ATD_DIO_INDEX_BAK4_CHAN   8     //开关4对应模拟信号，对应接插件X17   3
    #define _ATD_DIO_INDEX_BAK5_CHAN   9     //开关5对应模拟信号，对应接插件X18   4
    #define _ATD_DIO_INDEX_BAK6_CHAN   10    //开关6对应模拟信号，对应接插件X13   5
    #define _ATD_DIO_INDEX_BAK7_CHAN   11    //开关7对应模拟信号，对应接插件X14   6
    #define _ATD_DIO_INDEX_BAK8_CHAN   12    //开关8对应模拟信号，对应接插件X9    7
    #define _ATD_DIO_INDEX_BAK9_CHAN   13    //开关9对应模拟信号，对应接插件X5    8
    #define _ATD_DIO_INDEX_BAK10_CHAN   14   //开关10对应模拟信号，对应接插件X6   9
    #define _ATD_DIO_INDEX_BAK11_CHAN   15   //开关11对应模拟信号，对应接插件X3   10
    #define _ATD_DIO_INDEX_BAK12_CHAN   16   //开关12对应模拟信号，对应接插件X4   11
    #define _ATD_DIO_INDEX_BAK13_CHAN   17   //开关13对应模拟信号，对应接插件X7   12
    #define _ATD_DIO_INDEX_BAK14_CHAN   18   //开关14对应模拟信号，对应接插件X11  13
    #define _ATD_DIO_INDEX_BAK15_CHAN   19   //开关15对应模拟信号，对应接插件X15  14
    #define _ATD_DIO_INDEX_BAK16_CHAN   20   //开关16对应模拟信号，对应接插件X19  15
    #define _ATD_DIO_INDEX_BAK17_CHAN   21   //开关17对应模拟信号，对应接插件X22  16
    #define _ATD_DIO_INDEX_BAK18_CHAN   22   //开关18对应模拟信号，对应接插件X23  17
    ...
    #define _DIO_INDEX_BAK4_CHAN    3   //开关4信号，对应接插件X17     R_MODE
    #define _DIO_INDEX_BAK5_CHAN    4   //开关5信号，对应接插件X18     DOOR
    ...
    #define _DIO_INDEX_BAK16_CHAN   15  //开关16信号，对应接插件X19     R
    #define _DIO_INDEX_BAK17_CHAN   16  //开关17信号，对应接插件X22     N
    #define _DIO_INDEX_BAK18_CHAN   17  //开关18信号，对应接插件X23     D
    
    uint8 DIODrv_GetChanState(uint8 idxChanUB); //得到上述通道的D值
    ...
    //PWM型信号输出（低边驱动）
    #define _LSPWM_INDEX_BAK1_CHAN  0  //输出1，对应接插件X45       PWM
    ...
    #define _PSWT_INDEX_BAK9_CHAN    8    //驱动9，对应接插件X20    IN1
    #define _PSWT_INDEX_BAK10_CHAN   9    //驱动10，对应接插件X16   IN2
    ...
    *******************************************************************************************/
    ...
    #define _ECUSN_LENGTH_NUM_MAX 20
    
    #pragma CONST_SEG __GPAGE_SEG ECUSN_FLASH    
            
         extern volatile const uint8 ECUSN_idxUB_CA[_ECUSN_LENGTH_NUM_MAX];//ECU流水号 _ECUSN_LENGTH_NUM_MAX 
        
    #pragma CONST_SEG DEFAULT         //这个数组就是流水号的ASCII值，有效字符以0结束
